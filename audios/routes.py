...
audios_blueprint.add_url_rule('/transcriptions/<int:user_id>/', view_func=detail_transcription, methods=['GET'])
audios_blueprint.add_url_rule('/transcriptions/<int:user_id>/', view_func=update_transcription, methods=['PUT'])
audios_blueprint.add_url_rule('/transcriptions/<int:user_id>/', view_func=delete_transcription, methods=['DELETE'])
